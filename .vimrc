...
" 代码折叠 操作：za，打开或关闭当前折叠；zM，关闭所有折叠；zR，打开所有折叠
set foldmethod=syntax        " 代码折叠类型 语法
"set foldmethod=indent        " 代码折叠类型 缩进
set nofoldenable             " 启动时时关闭折叠代码
...
"nmap <Leader>ig <Plug>IndentGuidesToggle " 快捷键 i 开关缩进可视化
" 设置颜色
...
" focus the NERDTree or create it if focus is on a file, unfocus NERDTree if focus is on NERDTree
map <Leader>n <plug>NERDTreeTabsToggle<CR>
map <Leader>s <plug>NERDTreeFocusToggle<CR>
